...
//  Step Tracker
//
//  Created by Jeremy Cinq-Mars on 2024-05-30.
//
        ...
        ChartContainer(chartType: .weightDiffBar) {
            Chart {
                ...
                ForEach(chartData) { weightDiff in
                    ...
                    .accessibilityLabel("\(weightDiff.value.formatted(.number.precision(.fractionLength(1)).sign(strategy: .always()))) pounds")
                }
            }
            .frame(height: 150)
...
#Preview {
    WeightDiffChart(chartData: MockData.weightDiff)
}
