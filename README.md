# Healthkit Tracker
HealthKit Tracker integrates Apple Health to show your latest step, weight (and eventually) workout data in animated, interactive Swift Charts. You can also see your average steps and weight gain/loss for each weekday for the past 28 days.

HealthKit Tracker also allows you to upload new data to the Apple Health app.
